...
function todayRo(): string {
  return new Date().toLocaleDateString("ro-RO"); // DD.MM.YYYY
}
...
// Ensure a cell exists in the worksheet before styling it
function ensureCell(ws: Record<string, unknown>, addr: string, value = "") {
...
const ROW_ALT    = "EFF6FF"; // alternating data row tint
const WHITE      = "FFFFFF";
...
function styleDataCell(rowIdx: number, bold = false): Record<string, unknown> {
