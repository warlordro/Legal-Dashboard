...
export async function buildManualPdf(): Promise<ExportResult> {
  ...
  addParagraph("Anthropic (Claude): Haiku 4.5 (Rapid), Sonnet 5 (Echilibrat), Opus 5 (Premium)");
  addParagraph("OpenAI (GPT): GPT-5.6 Luna (Rapid), GPT-5.6 Terra (Echilibrat), GPT-5.6 Sol (Premium)");
  addParagraph("Google (Gemini): Gemini 3.5 Lite (Rapid), Gemini 3.6 Flash (Echilibrat), Gemini 3.1 Pro (Premium)");
  ...
  addBullet("Modelele judecator sunt restrictionate la modele premium: Claude Opus 5, GPT-5.6 Sol sau Gemini 3.1 Pro");
