...
export const INSTITUTII: Institutie[] = [
  ...
  // ── Tribunale Specializate ─────────────────────────────────────────
  {
    value: "TribunalulpentruminoriSifamilieBRASOV",
    label: "Tribunalul pentru Minori și Familie Brașov",
    group: "Tribunale Specializate",
  },
  ...
  {
    value: "TribunalulMilitarTeritorialBUCURESTI",
    label: "Tribunalul Militar Teritorial București",
    group: "Tribunale Militare",
  },
