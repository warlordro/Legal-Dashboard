...
| `LEGAL_DASHBOARD_DEFAULT_RNPM_STORAGE_MB=500` | Limita implicita per user pentru baza RNPM vie; `0` sau negativ = nelimitat | Admission control pe cautari; override-ul `rnpm.storage` per user are prioritate |
