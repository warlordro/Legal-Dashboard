...
**Versiune curenta**: v2.43.0 (2026-07-20) — branch `feat/v2.43.0-rnpm-split`. Versiunea NU se bumpeaza: munca de dupa push-ul initial din 13 iulie se documenteaza ca extensie a lui v2.43.0 (decizie explicita a userului; `package.json` neatins).
...
Dupa push-ul initial v2.43.0 (13 iulie), pe acelasi branch s-au livrat si pushuit DOUA directii mari (fara bump de versiune), ambele dublu-review-uite adversarial (Codex GPT-5.6 Sol + panel multi-model):
...
Detaliul complet e in CHANGELOG "Update 2026-07-20" si SECURITY.md (rand `2026-07-20`). Sectiunile de mai jos raman istoric datat imutabil.
