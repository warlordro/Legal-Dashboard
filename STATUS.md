...
**Data curenta:** 2026-05-13 (v2.25.0: filtru RNPM multi-token cu logica AND peste rezultatele unei cautari salvate. Tokenizer backend/frontend cu deduplicare case-insensitive si diacritics-insensitive, cap anti-DoS `FILTER_TOKEN_MAX_COUNT = 8`, query backend cu grupe OR de 24 LIKE-uri combinate prin AND, highlight galben in randul colapsat si in tab-urile Creditori/Debitori/Bunuri/Istoric, plus badge `match in detalii` cand potrivirea este doar in expand.)
**Versiune curenta reala:** v2.25.0
