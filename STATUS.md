...
**Data curenta:** 2026-05-16 (v2.28.1: Bug fixes pentru stack chinezesc OpenRouter — `AI_MAX_TOKENS_CHINESE = 16000` (Kimi K2.6 thinking model lovea cap-ul 8000), bump `AI_MULTI_TIMEOUT_CHINESE` 300s -> 480s, frontend `analyze-multi` AbortSignal 300s -> 1020s, completare `JUDGE_MODELS` whitelist cu GLM 5.1 + Kimi K2.6, layout dialog Config Chei API unificat — Rutare AI + chei API providers grupate vizual.)
**Versiune curenta reala:** v2.28.1
