...
**Data curenta:** 2026-05-10 (v2.20.4: UX hardening pentru bulk RNPM la batch-uri mari — SSE timeout 10 min -> 60 min, UI MAX_BATCH 100 -> 200 cu hint pentru >150 CUI, rate-limit global 30 -> 120 req/min per (ip, ownerId))
**Versiune curenta reala:** v2.20.4
