...
**Data curenta:** 2026-05-19 (v2.32.0: extensie politici cota AI in web mode — perioade rolling day/week/month + buget nelimitat, granturi cu expirare emise de admin, soft warning la 80% prin banner + email anti-spam cu auto-clear, conversie EUR via cursul oficial BCE fetch-uit zilnic fail-closed la > 48h stale, pagini admin noi `/admin/grants` + `/admin/usage`. Desktop ZERO impact.)
**Versiune curenta reala:** v2.32.0
