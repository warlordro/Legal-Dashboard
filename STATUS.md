...
**Data curenta:** 2026-05-19 (v2.33.0: security hardening CRITICAL-1 + 5 HIGH + 11 MEDIUM + 3 LOW pe quota/budget, deployment topology, validation I/O si audit trail. Desktop ZERO impact, LAN bind opt-in, audit fara plaintext pentru secrete.)
**Versiune curenta reala:** v2.33.0
