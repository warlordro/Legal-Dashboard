...
**Data curenta:** 2026-05-13 (v2.26.0: PR-6 Envelope Migration. Rutele HTTP legacy din RNPM, AI si Termene returneaza envelope standard pe 4xx/5xx, `INSUFFICIENT_FUNDS` este 402 cu `Retry-After: 0`, `LIMIT_EXCEEDED.details` ramane disponibil pentru split-search, iar frontend-ul citeste dual-shape mesajele reale de eroare.)
**Versiune curenta reala:** v2.26.0
