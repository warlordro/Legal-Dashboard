...
**Data curenta:** 2026-05-08 (v2.20.3: hardening RNPM post-/full-review — audit retention 90z + requestId, fail-fast K=3, SSE abort/timeout/error, captchasUsed acumulat, allow-list canonica + kill switch)
**Versiune curenta reala:** v2.20.3
