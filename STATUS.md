...
**Data curenta:** 2026-05-19 (v2.31.0: server deployment stack - oauth2-proxy bridge endpoint `/auth/oauth2/sync` cu shared secret + timing-safe compare, Caddy auto-TLS + oauth2-proxy v7.7.1 + backend in Docker Compose, seed-admin.mjs idempotent, DEPLOY-SERVER.md ghid complet.)
**Versiune curenta reala:** v2.31.0
