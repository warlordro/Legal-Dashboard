...
**Data curenta:** 2026-05-14 (v2.27.1: fix cautari largi PortalJust — cap SOAP 8MB -> 50MB + typed `SoapResponseTooLargeError` mapat la 413 actionable pe /api/dosare si /api/termene, in loc de eroarea generica 500 "Incercati din nou.")
**Versiune curenta reala:** v2.27.1
