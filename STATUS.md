...
**Data curenta:** 2026-05-22 (v2.35.0: refresh stack OpenRouter chinezesc — Qwen 3.6 Max Preview inlocuit cu Qwen 3.7 Max GA. Slug `qwen/qwen3.7-max`, pricing $2.50/$7.50 per 1M tokens, fara migratie SQL. GLM 5.1 + Kimi K2.6 neschimbate. Slug-ul vechi ramane acceptat in `ai_usage` ca istoric.)
**Versiune curenta reala:** v2.35.0
