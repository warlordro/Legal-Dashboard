...
**Data curenta:** 2026-05-18 (v2.29.0: monitoring noise & storage - snapshot retention atomica, cap payload 3 MiB, set equality pe name_soap si suppressie dosar_new istoric cu latest_sedinta_at/jobCreatedAt.)
**Versiune curenta reala:** v2.29.0
