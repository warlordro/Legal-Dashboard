...
**Data curenta:** 2026-05-10 (v2.20.5: hotfix release pipeline — restaurate scripts/build/devDependencies din root package.json stripuite accidental in v2.20.4 + SSE_TIMEOUT_MS bumped 60 min -> 90 min ca sa acopere worst-case-ul de 200 CUI / 1 stream ipoteci ~83 min)
**Versiune curenta reala:** v2.20.5
