...
**Data curenta:** 2026-05-17 (v2.28.3: refactor closeout util - drop-export cleanup pe 7 simboluri interne, `withRnpmGuards` pe rutele RNPM cu captcha, teste invariants I1/I3/I-final-update si Tier 3/Tier 4 marcate DEFERRED in `audit/AUDIT-REFACTOR.md` §8.)
**Versiune curenta reala:** v2.28.3
