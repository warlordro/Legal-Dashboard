...
**Data curenta:** 2026-05-19 (v2.30.0: web admin keys + per-user budget - chei AI/captcha tenant criptate AES-256-GCM, /admin/keys, BYOK ascuns pentru non-admin web, quotaGuard AI si RNPM captcha server-side.)
**Versiune curenta reala:** v2.30.0
