...
**Data curenta:** 2026-05-22 (v2.36.0: React Error Boundaries pe tot arborele de UI — inchide finding-ul critic B1 din auditul intern. Componenta `ErrorBoundary` cu variante `app` (fallback full-page, montat in `main.tsx`) si `page` (fallback inline cu retry fara reload). Acoperire pe 12 sloturi de pagina plus Sidebar si ApiKeyDialog. Fara schimbari de schema sau de perimetru de securitate.)
**Versiune curenta reala:** v2.36.0
