...
**Data curenta:** 2026-06-14 (v2.38.0: refresh de modele AI (Opus 4.6 -> 4.8, Gemini 3 Flash -> 3.5 Flash, nativ + OpenRouter), eliminarea stack-ului OpenRouter chinezesc (GLM/Kimi/Qwen; migratia 0036 coerce chinese -> western), hardening de securitate (revocare JWT cu jwt_denylist la logout — migratia 0038, cookie sesiune SameSite Lax -> Strict, retragerea boot gate-ului redundant LEGAL_DASHBOARD_ACK_NO_AUTH), hardening AI (validare slug-uri OPENROUTER_MODEL_OVERRIDES, cap sedinte[]/parti[] la 500, disclaimer legal sub analiza, latency_ms/error_type per call — migratia 0037, fallback OpenAI chat.completions) si reziduuri din auditul adversarial 2026-06-13. Predecesor v2.37.1: hardening post-full-review — monitoring alerts corecte, RNPM timeout + TTL 15min, down-migratii cu cleanup _schema_versions, reziduuri ICCJ inchise.)
**Versiune curenta reala:** v2.38.0
