...
- Migrations in `backend/src/db/migrations/` (latest 0016)
...
- `npm test --workspace=backend` - vitest backend (822 teste in v2.19.1)
- `cd frontend && npm test -- --run` - vitest frontend (86 teste)
