...
- `npm test --workspace=backend` â€” vitest backend (703 teste dupa v2.10.5: 683 baseline v2.10.1 + 7 noi v2.10.3 + 8 noi v2.10.4 + 5 noi v2.10.5 in `alerts.test.ts` pentru `jobKind`, `q`, diacritice, wildcard escape si `q+jobKind` AND)
