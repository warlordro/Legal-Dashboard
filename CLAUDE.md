...
## Versiune Curenta
**v2.6.4** - 1 Mai 2026 (audit hardening finalizat: in-flight DELETE, fail-closed remote + originGuard CSRF, xlsx→exceljs, enrichment relaxed match, SSE alert_enriched, bulk delete atomic, metrici precise + alerts_patched)
