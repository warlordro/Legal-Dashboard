...
- `npm test --workspace=backend` â€” vitest backend (683 teste dupa v2.10.1: 645 baseline v2.9.x + 34 noi email settings/mailer/dispatcher/routes in v2.10.0 + 4 noi dispatcher hardening in v2.10.1)
