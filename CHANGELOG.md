...
### Update 2026-07-20 (post-release, acelasi branch `feat/v2.43.0-rnpm-split`, fara bump de versiune)

Munca livrata dupa push-ul initial din 13 iulie; versiunea ramane v2.43.0 (decizie explicita). Doua directii mari, ambele dublu-review-uite adversarial (Codex GPT-5.6 Sol + panel multi-model), plus finisaje UI.
