...
- **Versiune curenta**: **v2.33.0** (19 Mai 2026, security hardening CRITICAL-1 + 5 HIGH + 11 MEDIUM + 3 LOW pe quota/budget, deployment topology, validation I/O si audit trail. Desktop neimpactat). Pentru istoric complet vezi [CHANGELOG.md](CHANGELOG.md) si in-app changelog (`/changelog`).
