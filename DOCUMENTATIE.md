...
- **Versiune curenta**: **v2.20.0** (8 Mai 2026, RNPM cap observability — 3 gap reasons + audit `rnpm.cap_hit`). Pentru istoric complet vezi [CHANGELOG.md](CHANGELOG.md) si in-app changelog (`/changelog`).
